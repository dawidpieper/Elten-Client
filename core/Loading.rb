...
$appdata.delete!("\0")
$userprofile = "\0" * 16384
Win32API.new("kernel32","GetEnvironmentVariable",'ppi','i').call("userprofile",$userprofile,$userprofile.size)
$userprofile.delete!("\0")
...
loop_update
    ...
    $cw = Select.new(["Zaloguj Się","Rejestracja","Wyjście"])
    loop do
loop_update
      $cw.update
      update
